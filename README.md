...
|Netbox Secrets           |1.10.2|2.0.3 |2.1.2 |2.2.1 |???   |Active       |netbox-secrets                |netbox_secrets           |[NetBox Secrets](https://github.com/Onemind-Services-LLC/netbox-secrets)|
...
|Inventory                |1.6.0 |2.0.2 |2.2.1 |2.3.1 |---   |Active       |netbox-inventory              |netbox_inventory         |[Inventory Plugin](https://github.com/ArnesSI/netbox-inventory)|
