...
|Service Path (Maps)      |4.0.? |5.0.x |5.4.0  |6.1.1  |Active       |cesnet_service_path_plugin    |cesnet_service_path_plugin|[cesnet_service_path_plugin](https://github.com/CESNET/cesnet_service_path_plugin)|
...
|Validity                 |3.3.1 |3.3.1 |3.3.1  |3.4.3  |Active       |netbox-validity               |validity                 |[Validity](https://github.com/amyasnikov/validity)|
|Config Diff              |2.9.0 |2.10.0|2.12.0 |2.14.2 |Active       |netbox-config-diff            |netbox_config_diff       |[Config Diff](https://github.com/miaow2/netbox-config-diff)|
...
|LibreNMS Plugin          |0.3.12|0.3.18|0.4.2  |0.4.3  |Active       |netbox-librenms-plugin        |netbox_librenms_plugin   |[LibreNMS Plugin](https://github.com/bonzo81/netbox-librenms-plugin)|
...
|Circuit Mainten.         |0.5.0 |0.5.0 |0.6.0  |0.8.0  |Active       |netbox-circuitmaintenance     |netbox_circuitmaintenance|[Circuit Maintenance](https://github.com/jasonyates/netbox-circuitmaintenance)|
|Phonebox Plugin          |---   |---   |------ |-----  |---          |phonebox-plugin               |phonebox_plugin          |[Phonebox](https://github.com/iDebugAll/phonebox_plugin)|
|IP calculator            |1.4.9 |1.4.11|1.4.11 |-----  |Active       |netbox-ipcalculator           |netbox_ipcalculator      |[IP calculator](https://github.com/PieterL75/netbox_ipcalculator)|
|MetaType Importer        |0.6.0 |0.7.1 |0.8.1  |0.9.0  |Active       |netbox-metatype-importer      |netbox_metatype_importer |[Metatype Importer](https://github.com/Onemind-Services-LLC/netbox-metatype-importer)|
...
|Device view              |0.1.9 |---   |------ |0.1.15 |Unknown      |netbox-device-view            |netbox_device_view       |[Device View](https://github.com/peterbaumert/netbox-device-view)|
